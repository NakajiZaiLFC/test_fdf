...
valgrind -q --leak-check=full --show-leak-kinds=all ./fdf kokato_maps/caldera.fdf
valgrind -q --leak-check=full --show-leak-kinds=all ./fdf kokato_maps/mexican.fdf
valgrind -q --leak-check=full --show-leak-kinds=all ./fdf kokato_maps/parabola.fdf
valgrind -q --leak-check=full --show-leak-kinds=all ./fdf kokato_maps/sadle.fdf